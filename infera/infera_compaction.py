...
Operación de compactación para el brazo de historial resumido.

Cuando el prompt medido cruza la regla operativa configurada, se compacta:
...
La energía de esta llamada se mide en el runner y forma parte del costo total
de la política. Aquí solo se construyen los mensajes.
"""
