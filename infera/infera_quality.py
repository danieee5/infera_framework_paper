"""
infera_quality.py
Puntaje programático por tarea, entre 0 y 1.

Alcance:
  - Reglas comprobables por código:
      contains_all, contains_any, forbidden, required_fields, rota
  - Juez LLM opcional: el runner público no lo activa.

Cada método devuelve un subpuntaje. El valor final promedia las reglas
presentes y aplica `forbidden` como penalización multiplicativa. El resultado
no sustituye una revisión humana de exactitud, utilidad o calidad.
"""
